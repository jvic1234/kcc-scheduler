  ...
  <div style="max-width:520px;margin:40px auto;background:white;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
    ...
    <div style="padding:32px;">
      ...
      <div style="text-align:center;margin:28px 0;">
        <a href="${webcalUrl}" style="display:inline-block;background:linear-gradient(135deg,#1E3A8A,#2D4FA0);color:white;font-weight:800;font-size:15px;padding:14px 32px;border-radius:12px;text-decoration:none;">
      ...
      <div style="background:#F8FAFC;border:1px solid #E2E8F0;border-radius:10px;padding:14px;margin-bottom:24px;">
        ...
        <div style="font-size:11px;font-family:monospace;color:#6366F1;word-break:break-all;">${webcalUrl}</div>
      </div>
